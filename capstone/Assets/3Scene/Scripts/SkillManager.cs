...
public class SkillManager : MonoBehaviour
{
    ...
    { //text로 어떤 스킬을 사용한 것인지 감지하여, if문으로 알맞은 스킬을 발동 시킨다
        ...
        //스킬10
        if (SkillPanelManager.GetComponent<SkillPanelManager>().skillText.text == "풍향 제거 : 1턴 동안 풍향의 영향을 받지 않게 된다.")
        {
        ...
        //스킬11
        if (SkillPanelManager.GetComponent<SkillPanelManager>().skillText.text == "태풍 : 적이 1턴 동안 풍향의 영향을 2배로 받도록 공격한다.")
        {
