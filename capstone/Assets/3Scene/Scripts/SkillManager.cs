...
public class SkillManager : MonoBehaviour
{
    ...
    public void skillOn() { //text로 어떤 스킬을 사용한 것인지 감지하여, if문으로 알맞은 스킬을 발동 시킨다
        ...
        //스킬1
        if (SkillPanelManager.GetComponent<SkillPanelManager>().skillText.text == "과녁 크기 감소 : 과녁 크기 감소")
        {
        ...
        //스킬2
        if (SkillPanelManager.GetComponent<SkillPanelManager>().skillText.text == "과녁 크기 증가 : 과녁 크기 증가")
        {
        ...
        //스킬3
        if (SkillPanelManager.GetComponent<SkillPanelManager>().skillText.text == "과녁 움직이기 : 과녁 움직이기")
        {
